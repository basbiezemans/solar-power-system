...
function Battery(type) {
    ...
    function SolarBattery(dod) {
        ...
        /**
         * Calculate the required battery capacity for a given amount
         * of watt hours and battery backup days
         * @param {integer} watts Watt hours per day
         * @param {integer} backup 
         * @returns {integer} Watt hours
         */
        function capacity(watts, backup) {
